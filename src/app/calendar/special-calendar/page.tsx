...
import SpecialAttendanceForm from "@/components/SpecialAttendanceForm/page";

const SpecialCalendarView = forwardRef((props, ref) => {
...
SpecialCalendarView.displayName = "SpecialCalendarView";
